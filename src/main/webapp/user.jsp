...
<script type="text/javascript">
        ...
        buttons:[
            {
                ...
                handler:function(){
                    $('#importForm').form('submit', {
                        url:'${pageContext.request.contextPath}/puser/insertAppUser.do',
                        onSubmit:function(){
    ...
    $('#btn').click(function () {
        ...
        console.log('ss =     '+ss);
        $('#fff').form("submit",{
            url:'${pageContext.request.contextPath}/puser/addAppUser.do',
