...
<body style="background-image:url(/img/list.gif)";>

<div class="login" >

    <form id="fr"action="${pageContext.request.contextPath}/user/login.do">
    <table>
        <tbody>
        <tr>
            ...
            <td>
                <input type="text"  name="username" class="easyui-textbox" data-options="prompt:'张三',required:true" maxlength="20"/>
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <th>&nbsp;</th>
            <td>
                <input type="button" class="homeButton" value="" onclick="location.href='${pageContext.request.contextPath}/back/main.jsp'"><input type="submit" class="loginButton" value="登录">
            </td>
        </tr>
        </tbody>
